...
function TopRecipe() {
  ...
  return (
    <>
      <>
        <div id="project">
          <div className="container card bg-transparent mt-1 p-5" style={{border:"none"}}>
            <h1 className="sub-title text-center" style={{color:"#ff245b"}}> Top Trending Recipes</h1>

            <section id="portfolio" className="portfolio">
              <div className="container">
                <div className="row portfolio-container mt-5">
                  {
                  TopRecipe.map((top) => {
                    return (
